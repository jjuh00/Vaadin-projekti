...
import com.prodeca.data.SamplePerson;
import com.prodeca.services.SamplePersonService;
...
public class SupplierManagementView extends Div implements BeforeEnterObserver {
    ...
    private final String SAMPLEPERSON_EDIT_ROUTE_TEMPLATE = "suppliers/%s/edit";
    ...
    public SupplierManagementView(SamplePersonService samplePersonService) {
